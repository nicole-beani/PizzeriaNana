...
namespace PizzeriaNana.Controllers
{
    public class OrdiniController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdOrdine,DataOrdine,Importo,Indirizzo,Nota,IdCliente")] Ordini ordini)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdOrdine,DataOrdine,Importo,Indirizzo,Nota,IdCliente")] Ordini ordini)
        {
            if (ModelState.IsValid)
            {
